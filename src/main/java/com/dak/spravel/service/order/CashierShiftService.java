...
import com.dak.spravel.dto.request.order.ShiftRequest;
import com.dak.spravel.dto.response.order.ShiftResponse;
import com.dak.spravel.model.auth.User;
import com.dak.spravel.model.inventory.Branches;
import com.dak.spravel.model.order.CashierShift;
import com.dak.spravel.repository.auth.UserRepository;
import com.dak.spravel.repository.inventory.BranchesRepository;
import com.dak.spravel.repository.order.CashierShiftRepository;
...
public class CashierShiftService {
    ...
    public ShiftResponse closeShift(Long shiftId, ShiftRequest request) {
        ...
        BigDecimal cashRev = shiftRepository.calculateRevenueByMethod(
                ...
                com.dak.spravel.model.order.Payments.Method.CASH);
        ...
        BigDecimal transferRev = shiftRepository.calculateRevenueByMethod(
                shift.getCashier().getId(), shift.getBranch().getId(),
                shift.getStartedAt(), endedAt,
                com.dak.spravel.model.order.Payments.Method.TRANSFER);
