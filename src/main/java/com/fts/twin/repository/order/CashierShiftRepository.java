...
//     Hitung omzet 
    @Query("""
            ...
            WHERE o.cashier.id = :cashierId
              ...
              AND o.status     = com.fts.twin.model.order.Orders$PaymentStatus.PAID
...
//    Omzet Pembayaran
    @Query("""
            ...
            WHERE o.cashier.id = :cashierId
              ...
              AND o.status     = com.fts.twin.model.order.Orders$PaymentStatus.PAID
              AND p.method     = :method
              AND p.status     = com.fts.twin.model.order.Payments$Status.VERIFIED
              AND o.createdAt >= :startedAt
              AND o.createdAt <= :endedAt
            """)
    BigDecimal calculateRevenueByMethod(
            ...
            @Param("startedAt") java.time.LocalDateTime startedAt,
            @Param("endedAt") java.time.LocalDateTime endedAt,
            @Param("method") com.fts.twin.model.order.Payments.Method method);
