...
import com.fts.twin.dto.response.inventoryresponse.StockMutationResponse;
...
public class StockMutationService {
    ...
    public StockMutationResponse mapToResponse(StockMutation stockMutation) {
        ...
        if (stockMutation.getPartner() != null) {
            com.fts.twin.dto.response.components.PartnerSimpleDto pDto = new com.fts.twin.dto.response.components.PartnerSimpleDto();
        ...
        if (stockMutation.getCreatedBy() != null) {
            com.fts.twin.dto.response.components.UserSimpleDto u = new com.fts.twin.dto.response.components.UserSimpleDto();
