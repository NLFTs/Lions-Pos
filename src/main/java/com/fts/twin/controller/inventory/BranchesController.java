...
import com.fts.twin.dto.request.partner.BranchRequest;
import com.fts.twin.dto.response.ResData;
import com.fts.twin.dto.response.inventoryresponse.BranchResponse;
import com.fts.twin.service.inventory.BranchesService;
...
public class BranchesController { 
    ...
    @GetMapping("/{id}/users")
    @PreAuthorize("hasAuthority('branch.show')")
    public ResponseEntity<ResData<List<com.fts.twin.dto.response.UserResponse>>> getUsersByBranch(@PathVariable Long id) {
