...
const ALL_TASKS = computed(() => [
  ...
  },
  {
    ...
    detail: 'Produk adalah item yang bisa dijual di kasir atau dikelola stoknya di gudang. Setiap produk memiliki SKU unik, harga jual, dan bisa dikaitkan ke kategori. Tanpa produk, kasir tidak bisa beroperasi dan Proses Pembelian tidak bisa dibuat.',
    icon: Package,
  ...
  },
  {
    ...
    groupIcon: Building2,
    step: 4,
    title: 'Buat Gudang (Opsional)',
    desc: 'Siapkan gudang sebagai tempat penyimpanan stok.',
    detail: 'Gudang adalah tempat penyimpanan barang. Anda bisa punya beberapa gudang per cabang. Stok masuk dari Proses Pembelian, transfer antar gudang, dan stock opname semuanya berbasis gudang. Tanpa gudang, Proses Pembelian tidak bisa diarahkan ke mana pun.',
    icon: Warehouse,
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    groupIcon: Handshake,
    step: 5,
    title: 'Daftarkan Agen / Distributor',
    desc: 'Tambahkan pemasok yang menyediakan produk Anda.',
    detail: 'Agen / Distributor adalah pemasok atau vendor yang mengirimkan barang ke gudang Anda. Dengan mendaftarkan Agen / Distributor, Anda bisa membuat Pembelian untuk meminta pengiriman stok secara terstruktur, terlacak, dan bisa diaudit.',
    icon: Handshake,
  ...
  },
  {
    ...
    detail: 'Data Pembelian adalah dokumen resmi permintaan pembelian ke supplier. Setelah Pembelian dibuat dan dikirim ke Agen / Distributor, Anda melakukan penerimaan barang (receipt) yang otomatis menambah stok di gudang. Ini cara yang benar untuk mengisi stok secara terlacak.',
    icon: ClipboardList,
  ...
  },
  {
    ...
    desc: 'Pastikan stok produk sudah masuk ke gudang setelah Pembelian diterima.',
    detail: 'Setelah Proses Pembelian diterima (receipt), stok otomatis bertambah di gudang tujuan. Buka halaman Saldo Stok untuk memverifikasi bahwa jumlah stok sudah sesuai. Jika perlu koreksi manual, gunakan fitur "Tambah Stok" di halaman yang sama.',
    icon: PackageCheck,
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    step: 8,
    title: 'Buat Voucer Diskon (Opsional)',
