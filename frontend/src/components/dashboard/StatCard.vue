...
const props = defineProps({
  ...
  trend: { type: String, default: null }, // e.g. '+12%', '-5%'
...
const wrapperClass = computed(() => {
  const base = 'group relative overflow-hidden rounded-xl border border-border/60 bg-card p-5 shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-200 cursor-pointer'
